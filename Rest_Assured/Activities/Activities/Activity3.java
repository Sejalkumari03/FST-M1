...
public class Activity3 {
    ...
    public void addPets() {
        String reqBody = "{\"id\": 929011, \"name\": \"peter\", \"status\": \"alive\"}";
        Response response = given().spec(requestSpec) // Use requestSpec
                .body(reqBody) // Send request body
                .when().post(); // Send POST request

        reqBody = "{\"id\": 862891, \"name\": \"john\", \"status\": \"alive\"}";
    ...
    public void getPets(int id, String name, String status) {
        Response response = given().spec(requestSpec) // Use requestSpec
                .pathParam("petId", 929011) // Add path parameter
    ...
    public void deletePets(int id, String name, String status) {
        Response response = given().spec(requestSpec) // Use requestSpec
                .pathParam("petId", 862891) // Add path parameter
