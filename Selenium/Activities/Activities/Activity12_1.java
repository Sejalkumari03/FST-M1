...
public class Activity12_1 {
    public static void main(String[] args) {
        ...
        //Click button in iFrame 1
		  ...
		  System.out.println(button1.getCssValue("background-color")); button1.click();
		  ...
		  System.out.println(button2.getCssValue("background-color")); button2.click();
		  
		  //Print New Button Info 
		  System.out.println(button2.getText());
		  System.out.println(button2.getCssValue("background-color"));
		  
		  //Switch back to parent page driver.switchTo().defaultContent();
